    ...
    <div className="App">
      <div className="section1">
        ...
        <div className="socialsBlock">
          <a href="https://google.com/" target="_blank" rel="noopener noreferrer"><img alt="telegram" src={TG} /></a>
          <a href="https://google.com/" target="_blank" rel="noopener noreferrer"><img alt="twitter" src={TW} /></a>
        </div>
      </div>
